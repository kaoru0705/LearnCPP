...
private:
    ...
    void increasing_piston_speed() { std::cout << "increasing_piston_speed" << std::endl; };
    void decreasing_piston_speed() { std::cout << "decreasing_piston_speed" << std::endl; };
};
...
private:
    ...
    void increasing_motor_speed() { std::cout << "increasing_motor_speed" << std::endl; };
    void decreasing_motor_speed() { std::cout << "decreasing_motro_speed" << std::endl; };
};
